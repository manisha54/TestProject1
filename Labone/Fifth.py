...
5. A school decided to replace the desks in three classrooms. Each desk sits two students.
 Given the number of students in each class, print the smallest possible number of desk
 that can be purchased. The program should read three integers: the number of students in each of the three
...
print(f"Remaning desk for second class is {remain_class2} ")
remain_class3 = (no_student_class3 % 2)
print(f"remaning desk for third class is {remain_class3} ")
